...
import SolarCardsGrid from './pages/product/Productsolar';
import InverterCardGrid from './pages/product/Productinverter';
  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path='/products/vikram-solar' element={<SolarCardsGrid />} />
        <Route path='/products/fronius-solar' element={<InverterCardGrid />} />
